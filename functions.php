...
function twentytwenty_register_styles() {
	...
	wp_enqueue_style( 'menu-style', get_template_directory_uri() . '/assets/css/menu.css', 'menu' );
	wp_enqueue_style( 'slick-style', get_template_directory_uri() . '/assets/css/slick.css', 'menu' );
	wp_enqueue_style( 'fontawsome-style', get_template_directory_uri() . '/assets/css/fontawsome.css', 'menu' );
...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'jquery-js', get_template_directory_uri() . '/assets/js/jquery.min.js', array(), $theme_version, false );
	wp_enqueue_script( 'menu-js', get_template_directory_uri() . '/assets/js/menu.js', array(), $theme_version, false );
	wp_enqueue_script( 'slick-js', get_template_directory_uri() . '/assets/js/slick.min.js', array(), $theme_version, false );
	wp_enqueue_script( 'general-js', get_template_directory_uri() . '/assets/js/general.js', array(), $theme_version, false );
}
...
function twentytwenty_menus() {
	...
	$locations = array(
		'primary'  => __( 'Desktop Horizontal Menu primary', 'twentytwenty' ),
		'expanded' => __( 'Desktop Expanded Menu', 'twentytwenty' ),
		'mobile'   => __( 'Mobile Menu', 'twentytwenty' ),
		'footer one'   => __( 'FooterOne Menu', 'twentytwenty' ),
		'footer two'   => __( 'FooterTwo Menu', 'twentytwenty' ),
		'footer three'   => __( 'FooterThree Menu', 'twentytwenty' ),
